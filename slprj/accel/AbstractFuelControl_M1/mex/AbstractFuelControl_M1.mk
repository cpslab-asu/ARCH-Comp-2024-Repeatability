...
MODULES                 = AbstractFuelControl_M1_acc.c AbstractFuelControl_M1_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\AbstractFuelControl_M1_acc.mexw64
MAKEFILE                = AbstractFuelControl_M1.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022a
START_DIR               = E:\LSemiBO\LSemiBO\demos
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 7
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:AbstractFuelControl_M1_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = AbstractFuelControl_M1_acc.mexw64
MODELREF_LINK_LIBS        = 
...
AbstractFuelControl_M1_acc.obj : $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc.c

AbstractFuelControl_M1_acc_data.obj : $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AbstractFuelControl_M1\AbstractFuelControl_M1_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\AbstractFuelControl_M1\rt_nonfinite.c
