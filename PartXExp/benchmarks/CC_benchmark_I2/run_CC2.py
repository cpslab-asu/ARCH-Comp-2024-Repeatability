...
class Benchmark_CC2(Benchmark):
    def __init__(self, benchmark, instance, results_folder) -> None:
        ...
        self.optimizer = PartX(
            BENCHMARK_NAME=f"{benchmark}_budget_{self.MAX_BUDGET}_{self.NUMBER_OF_MACRO_REPLICATIONS}_reps_instance_{instance}",
        ...
        self.options = Options(runs=1, iterations=self.MAX_BUDGET, interval=(0, 100),  signals=self.signals)
