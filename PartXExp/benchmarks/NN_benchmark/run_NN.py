...
from .NN_specifications import load_specification_dict
...
class Benchmark_NN(Benchmark):
    def __init__(self, benchmark, instance, results_folder) -> None:
        ...
        self.options = Options(runs=1, iterations=self.MAX_BUDGET, interval=(0, 40),  signals=self.signals)
